...
class Paciente(Base):
    ...
    resultados_laboratorio = relationship("ResultadoLaboratorio", back_populates="paciente", lazy="selectin")
    resultados_imagenes = relationship("ResultadoImagen", back_populates="paciente", lazy="selectin")
    alertas = relationship("AlertaClinicaPaciente", back_populates="paciente", lazy="selectin")
